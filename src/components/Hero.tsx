    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-6 md:mb-8 rotate-45 border-2 border-white/30 hover:border-white/60 transition-all duration-500 hover:rotate-90 hover:scale-110"></div>
          
          <p className="text-lg md:text-xl lg:text-2xl text-white/90 mb-8 font-light animate-fade-in delay-500">
